...
module.exports.listen = function(server, mongostore) {
    ...
    io.on('connection', function(socket) {
        ...
        socket.on('disconnect', function() {
            ...
            if (chat_users_list[socket.id]){//If the user exists in chat list (active chat)
                //get the winner's user id
                room_id = queue_manager.chat_user_disconnect(socket.id);
                ...
                //set the data in the database on the user's profile
                chat_winner.set_win(user_socket_id);
